...
function Scrimba() {
  return (
    <img
      src="./d00055f2-ad89-4456-a1b8-f2416f5d1ce8.png"
      width="24"
      height="24"
...
function HNG() {
  return <Image src="/hnglogo.png" width={24} height={24} alt="HNG Logo" />;
}

function CertificateCard(props) {
  return (
    <div className="cert-card">
      <img src={props.certificateScreenshot} alt={props.certificateTitle} />
      <div className="courseProvider">
        {props.courseProviders.map((e) => (
          <span key={e.name}>
            {e.logo}
            {e.name}{" "}
          </span>
      ...
      <p className="certificateType">{props.certificationType}</p>
    </div>
  );
}
...
const certificateList = [
  {
    certificateTitle: "HNG Internship",
    certificationType: "Internship Certificate",
    certificateScreenshot: "/HNG Certification.jpg",
    verificationLink: "https://certgo.app/c-18cfcc63",
    courseProviders: [{ name: "HNG", logo: <HNG /> }],
  },
  {
    ...
    verificationLink:
      "https://scrimba.com/certificate-cert2CsEjr6BTZmgNpTamXsLPdUMvHcunPqH8c",
    courseProviders: [{ name: "Scrimba", logo: <Scrimba /> }],
  },
  {
    certificateTitle: "Learn JavaScript",
    certificationType: "Course Certificate",
    certificateScreenshot: "./Screenshot 2024-09-26 102741.png",
    verificationLink:
      "https://v2.scrimba.com/certificate-cert2CsEjr6BTZmgNpTamXsPNDivzd6SLRvH8p",
    courseProviders: [{ name: "Scrimba", logo: <Scrimba /> }],
  },
  // {
  //     certificateTitle: "Introduction to Frontend Development",
  //     certificationType: "Course Certificate",
  //     certificateScreenshot: "./introtofrontendcertificate.jpeg",
  //     verificationLink: "https://coursera.org/share/7391fa1e475f4f5362309cd8896e08b8",
  //     courseProviders: [{name: 'Meta', logo: <Meta />}, {name: 'Coursera', logo: <Coursera />}]
  // },
  {
    certificateTitle: "Version Control",
    certificationType: "Course Certificate",
    certificateScreenshot: "./versioncontrol.jpeg",
    verificationLink:
      "https://coursera.org/share/7d3018f410d2fe7362f47469f0fdc542",
    courseProviders: [
      { name: "Meta", logo: <Meta /> },
  ...
  {
    certificateTitle: "Programming With JavaScript",
    certificationType: "Course Certificate",
    certificateScreenshot: "./javascript.jpeg",
    verificationLink:
      "https://coursera.org/share/b80113980484501cb260c224ed5e6a84",
    courseProviders: [
      { name: "Meta", logo: <Meta /> },
      { name: "Coursera", logo: <Coursera /> },
    ],
  ...
  {
    certificateTitle: "HTML and CSS Indepth",
    certificationType: "Course Certificate",
    certificateScreenshot: "./CERTIFICATE_LANDING_PAGE~72LNCX57AK4R.jpeg",
    verificationLink:
      "https://coursera.org/share/87bcaffb5c678f72a0ff95826e356e43",
    courseProviders: [
      { name: "Meta", logo: <Meta /> },
      { name: "Coursera", logo: <Coursera /> },
    ],
    ...
    <div className="certification">
      {certificateList.map((e) => (
        <CertificateCard
          ...
          certificateScreenshot={e.certificateScreenshot}
          verificationLink={e.verificationLink}
          courseProviders={e.courseProviders}
          key={e.verificationLink}
        />
      ))}
    </div>
  );

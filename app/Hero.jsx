...
function Hero() {
  ...
  return (
    <section className="hero-section">
      <h1 style={style}>Frontend Web Developer</h1>
      <div className="hero">
        <div className="card">
          <img
        ...
        <div className="aboutText">
          <h1>
            Hey
            <br /> I&apos;m <span className="name">Ayomide</span>,<br />{" "}
            Frontend Developer
          </h1>
          <p>
          ...
          <a href="https://wa.me/+2347014329650" target={"_blank"} style={{display: "inline-block"}}>
            <h2>
              <span className="name">Then Let&apos;s Talk</span>
              <svg
                width="22"
                height="18"
                viewBox="0 0 22 18"
